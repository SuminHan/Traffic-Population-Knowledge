...
class MyDCGRUSTEIM(tf.keras.layers.Layer):
    def __init__(self, extdata, args):
        super(MyDCGRUSTEIM, self).__init__()
        self.D = args.D
        self.P = args.P
        self.Q = args.Q
        self.num_nodes = extdata['num_nodes']
...
class MyDCGRUSTE0ZCFBD0(tf.keras.layers.Layer):
    ...
    def build(self, input_shape):
        ...
        from experiment.mymodels.deconvolutional_recurrent import DeConvLSTM2D
